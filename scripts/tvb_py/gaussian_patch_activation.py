...
plt.legend()
plt.savefig(os.path.join(results_dir, "gaussian_activation_signal.png"), dpi=600, bbox_inches='tight')
...
plt.xlabel("Time (ms)")
plt.ylabel("Amplitude")
plt.savefig(os.path.join(results_dir, "gaussian_eeg_signal.png"), dpi=600, bbox_inches='tight')
